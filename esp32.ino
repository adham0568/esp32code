...
#define API_KEY "AIzaSyA2eqSCQfjnqhDs1Ku1E3t96HgvmqM2-1I"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://test-86719-default-rtdb.europe-west1.firebasedatabase.app" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "aa@aa.aa"
...
void streamCallback(FirebaseStream data)
{
  ...
  num = data.intData();
    ...
    // يمكنك استخدام قيمة intValue كما تحتاج هنا
    Serial.printf("Received int value: %d\n", num);
